...
const VetViewOrders = () => {
  ...
  const handleExport = (format) => {
    ...
    if (format === "xlsx") {
      ...
      logVetAction(`Exported orders in xlsx`);
    }
    ...
    if (format === "pdf") {
      ...
      logVetAction(`Exported orders in PDF`);
    }
  };
                ...
                <tr key={order.id}>
                    ...
                    <select
                      ...
                      onChange={async (e) => {
                        ...
                        try {
                          ...
                          logVetAction(`Order status has been set in ${newStatus}`);
                  ...
                  <td>
                    ...
                    <select
                      ...
                      onChange={async (e) => {
                        ...
                        logVetAction(`Order payment has been set in ${newPaymentStatus}`);
                        fetchOrders();
                      }}
                  ...
                  <td>
                    <button
                      ...
                      type='button'
                      onClick={() => {
                        logVetAction(`Pressing view receipt no.#${order.id}`);
